...
1. **Per-opponent scouting dossiers** — roster with age range, NTRP (+ rating type C/S/A/D/M), WTN singles/doubles, TennisRecord dynamic rating; season singles/doubles records (**superseded 2026-08-03, issue #90**: the spec said last-six-months, which made the binder thinnest on the day it is used — a spring season is largely out of a rolling six-month window by an August tournament); results within this tournament; court-assignment tendencies; partner frequency; prior meetings vs. our players; and a **predicted lineup honestly labeled a guess**.
